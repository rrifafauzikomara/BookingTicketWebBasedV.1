        ...
        <div class="well">
            <fieldset>
                <form class="form-horizontal form-label-left" method="post" action="" enctype="multipart/form-data">
                    ...
                    <input class="form-control col-md-7 col-xs-12" data-validate-length-range="4" data-validate-number="4" name="no_pesan" type="text">
                    </div>
                    </div>
                    <div class="item form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama">Nama Lengkap <span class="required"></span></label>
                    <div class="col-md-4 col-sm-4 col-xs-12">
                    <input class="form-control col-md-7 col-xs-12" data-validate-length-range="4" data-validate-number="4" name="nama" type="text">
                    </div>
                    </div>
                    <div class="item form-group">
        ...
        $tambah = @$_POST['input'];
          ...
          if ($tambah) {
            if ($no_pesan == "" || $nama == "" || $nama_gambar == "") {
                    ...
                    if ($pindah) {
                    $sql_insert = mysql_query("insert into tb_pembayaran values('', '$no_pesan', '$nama','$nama_gambar')") or die (mysql_error());
                       ?> <script type="text/javascript">alert("Upload Bukti Pembayaran Berhasil di Upload");</script> <?php

                       echo "<script type=text/javascript>
                                window.location.href='http://localhost/primajasa/index.php';
                                </script>" ;
                    } else {
