...
?>
                                    ...
                                    <form class="form-horizontal form-label-left" method="get" action=""  enctype="multipart/form-data">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input id="tgl_kebm" class="form-control col-md-7 col-xs-12" name="tgl_kebm" type="date" value="<?php echo date("Y-m-d");?>" >
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                        <label for="" class="control-label col-md-3">Jumlah Pemesanan </label>
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                        <input type="number" min="1" max="72" value="0" name="qty" step="1" data-validate-length="0" class="form-control col-md-7 col-xs-12" placeholder="">
                                        </div>
                                        </div>
                                        <div class="item form-group">
