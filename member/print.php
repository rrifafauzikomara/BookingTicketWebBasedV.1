...
while($row = mysqli_fetch_array($print))
	{
		echo '<font color=#"000000" size="3">Nomor Transaksi: '.$row['no_pesanm'].'<br><br>';
		echo 'Nama : '.$row['namam'].'<br><br>';
		echo 'Alamat: '.$row['alamatm'].'<br><br>';
    echo 'Jadwal Keberangkatan: '.$row['id_jadwal'].'<br><br>';
    echo 'Tanggal Keberangkatan: '.$row['tgl_kebm'].'<br><br>';
		echo 'No Hp: '.$row['kontakm'].'<br><br>';
		echo 'Harga: '.$row['hargam'].'<br><br>';
		echo 'Nomor Kursi: '.$row['seatm'].'<br><br>';
