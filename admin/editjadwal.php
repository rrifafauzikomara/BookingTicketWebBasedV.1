                ...
                <fieldset>
                    <?php
                       include "../inc/koneksi.php";
                        ...
                        if ($tambah) {
                            if ($id_jadwal == "" || $route == "" || $jam_keb == "" || $id_kendaraan == "" || $id_supir == "" || $harga == "") {
                                    ?> <script type="text/javascript">alert("Inputan tidak boleh kosong !!");</script> <?php
                            } else {
                                $sql_update = "update tb_jadwal set route='$route',jam_keb='$jam_keb', id_kendaraan='$id_kendaraan',id_supir='$id_supir',harga='$harga' where id_jadwal='$id_jadwal'" or die (mysqli_error());
                                $update = mysqli_query($con, $sql_update);
                                
                                echo "<script type=text/javascript>
                                window.location.href='http://localhost/primajasa/admin/datajadwal.php';
                                </script>" ;
                            }
                        } 
                                    ...
                                    <form class="form-horizontal form-label-left" method="post" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input id="jam_keb" type="text" value="<?php echo $data['jam_keb']; ?>" name="jam_keb" data-validate-length-range="10,12" class="optional form-control col-md-7 col-xs-12" maxlength="12" placeholder="Masukan Jam Keberangkatan">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input id="id_kendaraan" type="text" value="<?php echo $data['id_kendaraan']; ?>" name="id_kendaraan" data-validate-length-range="10,12" class="optional form-control col-md-7 col-xs-12" maxlength="12" placeholder="Masukan Jam Keberangkatan">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input id="id_supir" type="text" value="<?php echo $data['id_supir']; ?>" name="id_supir" data-validate-length-range="10,12" class="optional form-control col-md-7 col-xs-12" maxlength="12" placeholder="Masukan Jam Keberangkatan">
                                            </div>
                                        </div>
                                        <div class="item form-group">
