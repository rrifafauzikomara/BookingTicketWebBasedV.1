                ...
                <fieldset>
                    <form class="form-horizontal form-label-left" method="post" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input id="jam_keb" type="text" name="jam_keb" data-validate-length-range="10,12" class="optional form-control col-md-7 col-xs-12" maxlength="12" placeholder="Masukan Jam Keberangkatan">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input id="id_kendaraan" type="text" name="id_kendaraan" data-validate-length-range="10,12" class="optional form-control col-md-7 col-xs-12" maxlength="12" placeholder="Masukan Jam Keberangkatan">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input id="id_supir" type="text" name="id_supir" data-validate-length-range="10,12" class="optional form-control col-md-7 col-xs-12" maxlength="12" placeholder="Masukan Jam Keberangkatan">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input id="harga" type="text" name="harga" data-validate-length-range="10,12" class="optional form-control col-md-7 col-xs-12" maxlength="12" placeholder="Masukan Jam Keberangkatan">
                                            </div>
                                        </div>
                        ...
                        if ($tambah) {
                            if ($route == "" || $jam_keb == "" || $id_kendaraan == "" || $id_supir == "" || $harga == "") {
