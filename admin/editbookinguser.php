                ...
                <div class="well">
                    <?php
					   include "../inc/koneksi.php";
                        ...
                        if ($tambah) {
                            if ($no_pesan == "" || $nama == "" || $alamat == "" || $seat == "") {
                                    ?> <script type="text/javascript">alert("Inputan tidak boleh kosong !!");</script> <?php
                            } else {
                                $sql_update = "update tb_user set nama='$nama',alamat='$alamat',seat='$seat' where no_pesan='$no_pesan'" or die (mysqli_error());
								...
								window.location.href='http://localhost/primajasa/admin/databookinguser.php';
                                    ...
                                    <form class="form-horizontal form-label-left" method="post" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input id="seat" type="text" value="<?php echo $data['seat']; ?>" name="seat" data-validate-length-range="10,12" class="optional form-control col-md-7 col-xs-12" maxlength="12" placeholder="Masukan No Hp atau Tlp">
                                            </div>
                                        </div>  
