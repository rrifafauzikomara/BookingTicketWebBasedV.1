                ...
                <div class="well">
                    ...
                    <?php
                       include "../inc/koneksi.php";
                        ...
                        if ($tambah) {
                            if ($id_user == "" || $nama_user == "" || $alamat == "" || $no_hp == "" || $email == "" || $username == "" || $password == "" || $level == "") {
                                    ?> <script type="text/javascript">alert("Inputan tidak boleh kosong !!");</script> <?php
                            } else {
                                $sql_tambah = "update tb_registrasi set nama_user='$nama_user',alamat='$alamat',no_hp='$no_hp',email='$email', username='$username',password='$password',level='$level' where id_user='$id_user'" or die (mysqli_error());
                                ...
                                window.location.href='http://localhost/primajasa/admin/datauser.php';
                                    ...
                                    <form class="form-horizontal form-label-left" method="post" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input value="<?php echo $data['no_hp']; ?>" id="no_hp" type="text" name="no_hp" data-validate-length-range="10,12" class="optional form-control col-md-7 col-xs-12" maxlength="12" placeholder="Masukan No Hp atau Tlp">
                                            </div>
                                        </div>
                                        <div class="item form-group">
